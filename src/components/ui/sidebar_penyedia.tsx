...
const SidebarPenyedia = () => {
  ...
  const menuItems = [
    { href: "/dashboard_penyedia", icon: Home, label: "Dashboard" },
    { href: "/kelolaProdukPenyedia", icon: Package, label: "Katalog Produk" },
    { href: "/usulan_penyedia", icon: Lightbulb, label: "Usulan Kebutuhan" },
    { href: "/kelola_riset", icon: FileText, label: "Kelola Riset" },
